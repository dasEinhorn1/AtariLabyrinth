...
.L03 ;  const _P_Edge_Top  =  9

.L04 ;  const _P_Edge_Bottom  =  88

.L05 ;  const _P_Edge_Left  =  1

.L06 ;  const _P_Edge_Right  =  153
...
.L09 ;  ballheight  =  4  :  rem * Ball 4 pixels high.
...
.L010 ;  CTRLPF  =  $21  :  rem * Ball 4 pixels wide.
...
.L011 ;  COLUPF  =  $1E  :  rem * Ball/playfield color.
...
.L021 ;  if joy0up  &&  player1y  >  _P_Edge_Top then player1y  =  player1y  -  1
...
.L022 ;  if joy0down  &&  player1y  <  _P_Edge_Bottom then player1y  =  player1y  +  1
...
.L023 ;  if joy0left  &&  player1x  >  _P_Edge_Left then player1x  =  player1x  -  1
...
.L024 ;  if joy0right  &&  player1x  <  _P_Edge_Right then player1x  =  player1x  +  1
